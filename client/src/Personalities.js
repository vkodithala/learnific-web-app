  ...
  const writersData = [
    {
      ...
      imagePath: "/curators/sampleHeader.png",
    },
    {
      id: "writer2",
      name: "Leo Hart",
      image: "/curators/Hart.jpeg",
...
/>
      ...
      Read More
        ...
        <Link to="/end">
          <button className="mt-4 border-2 rounded-xl hover:bg-buttonColor hover:border-transparent hover:text-slate-100 font-semibold py-3 px-10 hover:bg-buttonColor border-buttonColor text-buttonColor transition duration-500" onClick={submitAnswers}>Confirm</button>
        </Link>
      </>
    )}
    </div>
