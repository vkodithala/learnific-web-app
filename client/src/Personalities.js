...
//this needs to be fixed
  const handleWriterSelect = (writerId) => {
    ...
    if (selectedWriter) {
      ...
      console.log(selectedWriterData)
      setSelectedWriter(selectedWriterData); // Set the entire writer object
      setSelectedPdf(selectedWriterData.pdf);
    }
  };
